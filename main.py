...
#Če bo čas
print("Na podlagi podatkov bomo poiskali najcenejšo različico karte do tvoje destinacije, pri tem bo upoštevali ceno goriva in število oseb!")
destinacija = input("Vpiši destinacijo na katero želiš potovati (mesto): ")
st_oseb = int(input("Vpiši število oseb, ki bodo potovale s tabo: "))